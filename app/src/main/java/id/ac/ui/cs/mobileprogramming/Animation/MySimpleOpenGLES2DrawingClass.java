...
public class MySimpleOpenGLES2DrawingClass {
    ...
    public float[] coords = {};// Argument 2
    private final int vertexCount;
    private final int vertexStride; // 4 bytes per vertex
    public float[] color= new float[4];

    public MySimpleOpenGLES2DrawingClass(int coordsPerVertex,float []coordinates,float[]color,short[]drawOrder) {
    ...
    public MySimpleOpenGLES2DrawingClass(int coordsPerVertex,float []coordinates,float[]color)
    {
        COORDS_PER_VERTEX=coordsPerVertex;
        coords=coordinates;
